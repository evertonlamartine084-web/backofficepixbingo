...
(function () {
  ...
  const ICONS = {
    ...
    gem: '<svg viewBox="0 0 24 24"><path d="M18.49 5.06h-6.53c-.27 0-.54.1-.75.28l-4.5 3.95a1.03 1.03 0 00-.39.87v6.09c0 .34.14.66.4.88l4.5 3.95c.2.18.47.28.74.28h6.53c.28 0 .54-.1.75-.28l4.5-3.95c.25-.22.4-.53.4-.87v-6.09c0-.34-.14-.66-.4-.88l-4.5-3.95a1.06 1.06 0 00-.75-.28z" fill="#80E239"/></svg>',
        ...
        if (isRouletteGame && game.type === 'gift_box' && miniGameResult.game_data?.boxes) {
          ...
          for (let i = 0; i < n; i++) {
            ...
            const gemIconSvg = isDiamondRoulette
              ? '<svg viewBox="0 0 24 24" width="16" height="16"><path d="M6 3h12l4 6-10 13L2 9Z" fill="#22d3ee" stroke="#06b6d4" stroke-width="1.5"/><path d="M11 3 8 9l4 13 4-13-3-6" fill="rgba(255,255,255,0.2)" stroke="#06b6d4" stroke-width="1"/><path d="M2 9h20" stroke="#06b6d4" stroke-width="1.5"/></svg>'
              : '<svg viewBox="0 0 24 24" width="16" height="16"><path d="M18.49 5.06h-6.53c-.27 0-.54.1-.75.28l-4.5 3.95a1.03 1.03 0 00-.39.87v6.09c0 .34.14.66.4.88l4.5 3.95c.2.18.47.28.74.28h6.53c.28 0 .54-.1.75-.28l4.5-3.95c.25-.22.4-.53.4-.87v-6.09c0-.34-.14-.66-.4-.88l-4.5-3.95a1.06 1.06 0 00-.75-.28z" fill="#80E239"/></svg>';
